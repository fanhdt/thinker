...
- **Frontend baru increment pertama**: `frontend/` (React + TypeScript + Tailwind v4 + Zustand, lihat DECISIONS.md ADR-014, menggantikan rencana lama Vue 3 yang tidak pernah diimplementasikan) baru punya satu view: Conversation. Memory, Goals, Tasks, Tools, Agents, Activity, dan Settings (§20 master prompt) belum ada UI-nya -- masih lewat REST API atau bot Telegram langsung.
